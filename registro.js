...
const registroCalculadoras = [
  {
    ...
    descricao:
      "Calcula a pressão arterial média a partir da PAS e PAD, com interpretação de perfusão.",
    area: "Cardiologia",
    tags: [
      "pressao arterial",
      "PAM",
  ...
  },
  {
    ...
    descricao:
      "Calcula a RAC urinária e classifica o estágio de albuminúria conforme critérios KDIGO.",
    area: "Nefrologia",
    tags: [
      "albuminuria",
      "RAC",
  ...
  },
  {
    ...
    descricao:
      "Calcule a osmolaridade plásmatica a partir dos eletrólitos e compare com a osmolaridade sérica encontrada.",
    area: "Nefrologia",
    tags: [
      "osmolaridade",
      "plasma",
  ...
  },
  {
    ...
    descricao:
      "Calcula a fração excretada de sódio para avaliar a função renal.",
    area: "Nefrologia",
    tags: [
      "fracao excretada",
      "sodio",
  ...
  },
  {
    ...
    descricao:
      "Estimativa da TFG pelas fórmulas Cockcroft-Gault, MDRD e CKD-EPI 2021.",
    area: "Nefrologia",
    tags: [
      "tfg",
      "tfge",
  ...
  },
  {
    ...
    descricao:
      "Cálculo da DPP pela Regra de Naegele via DUM ou USG obstétrica.",
    area: "Obstetrícia",
    tags: [
      "dpp",
      "parto",
  ...
  },
  {
    ...
    descricao:
      "Encontre o LDL-c segundo a fórmula de Friedewald e avalie a meta conforme o risco cardiovascular.",
    area: "Cardiologia",
    tags: [
      "ldl",
      "ldl-c",
  ...
  },
  {
    ...
    descricao:
      "Corrige os níveis de cálcio sérico com base na concentração de albumina para avaliar o real valor do eletrólito.",
    area: "Nefrologia",
    tags: [
      "calcio",
      "albumina",
  ...
  },
  {
    ...
    descricao:
      "Corrige os valores de reticulócitos conforme o grau da anemia do paciente.",
    area: "Hematologia",
    tags: [
      "reticulocitos",
      "anemia",
  ...
  },
  {
    ...
    descricao:
      "Estima a probabilidade pré-teste de TVP com base em critérios clínicos.",
    area: "Cirurgia",
    tags: [
      "wells",
      "tvp",
